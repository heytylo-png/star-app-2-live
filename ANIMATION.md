...
Standing full-body proof (CoS PASS): `artifacts/star-rai-blink-frames/baked/proof_standing_full.gif` and `proof_standing_strip.png`. Against frame 01, pixels outside the eye box stay at max abs RGB delta 0. Hair, skirt, and shoes do not move.
