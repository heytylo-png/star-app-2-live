...
const wave: CutoutClip = {
  ...
  bones: {
    ...
    forearmL: { rotate: keys([[0, 44]]) },
    handL: { rotate: keys([[0, 10]]) },
    ahoge: {
      rotate: keys([
        [0, -22],
        [0.8, -10],
...
const scold: CutoutClip = {
  ...
  bones: {
    ...
    forearmR: { rotate: keys([[0, 12]]) },
    handR: { rotate: keys([[0, 6]]) },
    upperArmL: { rotate: keys([[0, 40]]) },
    forearmL: { rotate: keys([[0, 46]]) },
    thighL: { rotate: keys([[0, -8]]) },
    thighR: { rotate: keys([[0, 8]]) },
    ahoge: { rotate: keys([[0, -20]]) },
  },
};
...
const pout: CutoutClip = {
  ...
  bones: {
    ...
    upperArmL: { rotate: keys([[0, -8]]) },
    upperArmR: { rotate: keys([[0, 8]]) },
    ahoge: {
      rotate: keys([
        [0, -36],
        [1.2, -30],
...
const shy: CutoutClip = {
  ...
  bones: {
    ...
    upperArmL: { rotate: keys([[0, 28]]) },
    forearmL: { rotate: keys([[0, 48]]) },
    upperArmR: { rotate: keys([[0, -24]]) },
    forearmR: { rotate: keys([[0, -42]]) },
...
export function sampleGirlSkeleton(): CutoutSkeleton {
  return {
    ...
    bones: [
      ...
      { name: "ahoge", parent: "head", x: -18, y: -48, rotation: -28, length: 54 },
      { name: "shoulderL", parent: "chest", x: 48, y: -18 },
      { name: "upperArmL", parent: "shoulderL", x: 8, y: 14, rotation: -16, length: 52 },
      { name: "forearmL", parent: "upperArmL", x: 2, y: 50, rotation: -6, length: 46 },
      { name: "handL", parent: "forearmL", x: 0, y: 42, length: 18 },
      { name: "shoulderR", parent: "chest", x: -48, y: -18 },
      { name: "upperArmR", parent: "shoulderR", x: -8, y: 14, rotation: 16, length: 52 },
      { name: "forearmR", parent: "upperArmR", x: -2, y: 50, rotation: 6, length: 46 },
    ...
    slots: [
      ...
      slot("ahoge", "ahoge", att("ahoge", [
        { type: "polygon", points: [4, 10, -4, 8, -28, -36, -8, -22], fill: HAIR },
        { type: "ellipse", cx: -30, cy: -38, rx: 9, ry: 6, fill: HAIR },
      ])),
    ],
